    ...
    return (
        <div className="relative flex flex-col justify-start items-center min-h-[100vh]  w-[10vw] md:w-[20vw] bg-white border-r-[1px] border-gray-400 ">
            ...
            <div className="h-[88vh] w-full flex flex-col justify-start items-center overflow-x-hidden">
                ...
                <Link href="/playground" className="flex flex-row justify-start items-center gap-4 mt-8 w-full active:border-r-8 active:border-[#48AEF3] pl-[1vw] md:pl-[4vw] active:bg-gradient-to-r   from-white to-blue-100 h-[8vh]">
